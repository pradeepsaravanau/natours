...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicHJhZGVlcHNhcmF2YW5hIiwiYSI6ImNremZoeHdkZzByNmgydm55NjEyMzBibTcifQ.8jIXCBbV-6mPz40B4FPckQ';
  var map = new mapboxgl.Map({
    //container here is seto to map what does that mean is that it will put the map with the element id of map
    container: 'map',
    // container ID
    style: 'mapbox://styles/pradeepsaravana/ckzfk007w005k14o29bnety0h',
    // style URL
    scrollZoom: false
  });
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      ...
      anchor: 'bottom' //array of longitudes and latitudes thats what setLngLat accepts so easy

    }).setLngLat(loc.coordinates) //map is the variable above
    .addTo(map); //add popup
...
var hideAlert = function hideAlert() {
  var el = document.querySelector('.alert'); //In order to remove the element parentElement from child element
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Logged In Successfully!'); //setting timeout with 1500ms and assigning the home page with location.assign
...
var stripe = Stripe('pk_test_51KW161JGVNWlhaVOdV4ZcqMz2sTZJrVHKEtxLZbLzdZhCdwILaIzmBZhomMSDzBzKVNtkf6cReo8T0YCQ0cH9NDK003Vs7MJU0');
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(tourId, dateId) {
    var session;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://127.0.0.1:3000/api/v1/bookings/checkout-session/".concat(tourId, "/").concat(dateId));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'please verify your email address!'); //setting timeout with 1500ms and assigning the home page with location.assign

              window.setTimeout(function () {
                location.assign("/users/".concat(email));
              }, 1500);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"createReview.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Created Review Successfully'); //setting timeout with 1500ms and assigning the home page with location.assign
            }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"confirmEmail.js":[function(require,module,exports) {
"use strict";
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(token, email) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: 'http://127.0.0.1:3000/api/v1/users/verifyEmail/',
              data: {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Email Id verified'); //setting timeout with 1500ms and assigning the home page with location.assign
  ...
  return function confirmEmail(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var confirmEmailForm = document.querySelector('.form--verify-email');
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  e.preventDefault(); //programatically create multipart data
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            document.querySelector('.btn--save--password').textContent = 'Updating....'; //inorder to perform operation after this task we await in a async function
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    e.target.textContent = 'Processing'; //dataset-tour-id tour-id is converted to tourId
...
if (reviewForm) {
  var Review = document.querySelector('.reviews__review');
  var rating = 0;
      ...
      for (var i = 0; i < 5; i++) {
        if (rating > i) {
          if (e.target.closest('.reviews__rating')) {
            e.target.closest('.reviews__rating').children[i].classList.remove('reviews__star--inactive');
            e.target.closest('.reviews__rating').children[i].classList.add('reviews__star--active');
          }
        } else {
          e.target.closest('.reviews__rating').children[i].classList.add('reviews__star--inactive');
          e.target.closest('.reviews__rating').children[i].classList.remove('reviews__star--active');
        }
      }
    }
  });
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              tour = document.querySelector('.tourId').dataset.id;
              console.log(tour);
              _context2.next = 6;
              return (0, _createReview.createReview)({
                tour: tour,
                rating: rating,
                review: review
              });
