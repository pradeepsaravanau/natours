...
exports.alerts = (req, res, next) => {
  ...
  if (alert === 'booking') {
    res.locals.alert =
      "Your booking was successfull . Please check your email for confirmation . If your booking doesn't show up here immediately . please check later ";
  }
  next();
};
...
exports.getTour = catchAsync(async (req, res, next) => {
  ...
  console.log('slug is ', tour.reviews);
  if (!tour) {
